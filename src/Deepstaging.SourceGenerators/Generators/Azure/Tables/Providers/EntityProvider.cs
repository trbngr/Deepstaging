...
namespace Deepstaging.SourceGenerators.Generators.Azure.Tables.Providers;
...
internal static class EntityProvider
{
    ...
    public static IncrementalValuesProvider<EntityInfo> ForDeepstagingEntities(this SyntaxValueProvider provider) =>
