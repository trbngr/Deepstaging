...
namespace Deepstaging.SourceGenerators.Generators.Configuration.Providers;

internal static class ConfigurationRegistrationProvider
{
    private static string AttributeFqn => "Deepstaging.ConfigurationRegistrationAttribute";

    public static IncrementalValuesProvider<ConfigurationRegistrationInfo> ForConfigurationRegistrations(
