...
PROJECT=Deepstaging.Sample
PROJECT_DIR=/Users/chris/code/deepstaging/src/Deepstaging.Sample
LOCAL_SECRETS="${PROJECT_DIR}/secrets.local.yaml"
EXAMPLE_DIR=/Users/chris/code/deepstaging/src/Deepstaging.Sample/config
